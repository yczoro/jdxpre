...
// 큰변동사항 없음
	...
	// $excel_object_ = PHPExcel_IOFactory::createReader(PHPExcel_IOFactory::identify($_SERVER["DOCUMENT_ROOT"]."/PHPExcel/Uploads/sabang_net_sample.xlsx"));
	// $excel_object_ ->setReadDataOnly(true);
	// $excel_object_ = $excel_object_->load($_SERVER["DOCUMENT_ROOT"]."/PHPExcel/Uploads/sabang_net_sample.xlsx");
	...
	// $fp = fopen( $_FILES['upfile_sbnet'][tmp_name], 'r' );
